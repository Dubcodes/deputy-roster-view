...
def main() -> None:
    ...
    from app.main import effective_schedule_items, schedule_people
    ...
    personal_source = _extract_management_shifts({"data": [
        {"id": 9401, "employee": 109, "area": 684, "areaName": "684", "areaLocationId": 64,
        ...
        {"id": 9402, "employee": 109, "area": 685, "areaName": "DIR", "areaLocationId": 64,
        ...
        {"id": 9403, "employee": 109, "area": 686, "areaName": "SVT", "areaLocationId": 65,
    ...
    save_deputy_web_schedule({
        ...
        "own_roster_coverage": [{"start_date": "2026-09-02", "end_date": "2026-09-08", "employee_id": 109,
